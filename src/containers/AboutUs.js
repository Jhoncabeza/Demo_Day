                ...
                <div className="h-90v flex flex-col items-center justify-center md:p-8 grid grid-cols-2">
                    ...
                    <div className="md:p-4">
                        <p className="text-xl text-justify text-gray-600">
                            Academia Geek es un campo de entrenamiento en Desarrollo Web que se
                            basa en retos reales. Su principal objetivo es lograr la
                            empleabilidad en el menor tiempo posible.
                        </p>
                        <p className="text-xl text-justify text-gray-600">
                            Como miembro de Academia Geek el estudiante hará parte de un
                            proyecto de desarrollo real, y construirá un portafolio profesional
                            que será muy útil para encontrar empleo. El entrenamiento incluye
                            formación técnica, Design Thinking, preparación para el empleo y
                            habilidades para la vida (Soft Skills).
                        </p>

                        <p className="text-xl text-justify text-gray-600">
                            La Academia cuenta con el respaldo de Makaia para el relacionamiento
                            con empresas y apoyo social y Agile Innova en la parte técnica y de
                            entrenamiento.
                        </p>
