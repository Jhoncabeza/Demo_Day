    ...
    return (
        <div className=" h-screen flex flex-col items-center justify-center">
            ...
            <div className="flex flex-row justify-content-between">
                <button className="flex items-center text-center bg-transparent border border-sky-300 w-36 text-sky-300 font-bold py-2 px-4 mr-4 rounded " type="button">
                    <SiFacebook className="mr-2"/>Facebook
                </button> 
                <button className="flex items-center text-center bg-transparent border border-sky-300 w-36 text-sky-300 font-bold py-2 px-4 rounded" type="button">
